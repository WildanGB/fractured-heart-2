...
monster_data = {
	...
	'tree': {'health': 100, 'exp': 50, 'damage': 20, 'attack_type': 'slash','attack_sound': '../assets/images/video assets/audio/attack/slash.wav', 'speed': 3, 'resistance': 3,
			 'attack_radius': 80, 'notice_radius': 360},
	'cherry tree': {'health': 100, 'exp': 50, 'damage': 20, 'attack_type': 'slash',
					'attack_sound': '../assets/images/video assets/audio/attack/slash.wav', 'speed': 3, 'resistance': 3,
					'attack_radius': 80, 'notice_radius': 360},
	'snowy tree': {'health': 100, 'exp': 50, 'damage': 20, 'attack_type': 'slash',
				   'attack_sound': '../assets/images/video assets/audio/attack/slash.wav', 'speed': 3, 'resistance': 3,
				   'attack_radius': 80, 'notice_radius': 360},
	'raccoon': {'health': 300, 'exp': 125, 'damage': 40, 'attack_type': 'claw',
				'attack_sound': '../assets/images/video assets/audio/attack/claw.wav', 'speed': 2, 'resistance': 3,
				'attack_radius': 120, 'notice_radius': 400},
	'spirit': {'health': 100, 'exp': 55, 'damage': 8, 'attack_type': 'thunder',
