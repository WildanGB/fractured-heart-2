...
class MainMenuScreen :
    def __init__ ( self , screen ) :
        ...
        self.prompt_rect = self.prompt_text.get_rect ( center = (WIDTH // 2 , HEIGTH // 2) )
        self.background_surface = pygame.Surface ( (WIDTH , HEIGTH) , pygame.SRCALPHA )
        ...
        self.background_blur = pygame.transform.smoothscale ( self.background_image , (
            WIDTH // 4 , HEIGTH // 4) )
        self.background_blur = pygame.transform.smoothscale ( self.background_blur , (WIDTH , HEIGTH) )
