...
class StartScreen:
    def __init__(self, screen):
        ...
        # Initialize level for background (used to generate a background image)
        self.level = Level()
        ...
        self.howto_content = [
            ...
            (self.howto_font_small, "Embark on a top-down adventure inspired by classic Zelda titles.", TEXT_COLOR),
            (self.howto_font_small, "Explore a sprawling map, battle fierce enemies, and uncover hidden secrets.", TEXT_COLOR),
    ...
    def display_credits(self):
        ...
        elements = [
            ...
            (self.credits_font_med, "Created for the 2025 Computer Science Game Project", 130, TEXT_COLOR),
